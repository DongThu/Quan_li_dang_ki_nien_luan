    ...
    <div class="container border">
        <div class="div_container" style=" height: 530px">
            ...
            <div class="groupbox" style="
				...
				<br>
				<br>
				<img src="../img/trotay.png" style="height: 38px;left: 35px;position: absolute; top: 210px;"alt="">
				<a style="text-decoration: none;  position: relative; left: -50px;"  href="login_sv.php">Sinh viên đăng nhập tại đây!</a>
				</form> 
			</div>
	</main>
