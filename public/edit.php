		...
		<div class="div_container"  style="height: 700px;">
			...
			<form name="frm" id="frm" action="" method="post" class="col-md-6 col-md-offset-3">
							...
							<div class="form-group<?= isset($errors['DiemSo']) ? ' has-error' : '' ?>">
								...
								<textarea name="DiemSo" id="DiemSo" class="form-control" placeholder="Điểm số có giá trị từ 0-10"><?= htmlspecialchars($kq->DiemSo) ?></textarea>
							...
							<div class="form-group<?= isset($errors['NhanXet']) ? ' has-error' : '' ?>">
								...
								<textarea name="NhanXet" id="NhanXet" class="form-control" placeholder="Nhận xét không quá 255 kí tự"><?= htmlspecialchars($kq->NhanXet) ?></textarea>
